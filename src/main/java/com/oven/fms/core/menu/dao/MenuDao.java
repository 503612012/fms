package com.oven.fms.core.menu.dao;
...
public class MenuDao extends BaseDao<Menu> {
    ...
    public List<Menu> getByPid(Integer pid) {
        return super.getAll(ConditionAndParams.build("pid", pid).andEq("`status`", 0), "sort");
    }
    ...
    public List<Menu> getByPidAndHasPermission(Integer pid, List<Integer> menuIds) {
        return super.getAll(ConditionAndParams.build("pid", pid).andEq("status", 0).andIn("dbid", menuIds), "sort");
    }
