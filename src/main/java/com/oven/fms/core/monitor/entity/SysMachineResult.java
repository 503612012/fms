package com.oven.fms.core.monitor.entity;
...
public class SysMachineResult implements Serializable {
    ...
    public static class SysJvmMemInfo {
        ...
        public String toString() {
            return "SysMachineResult.SysJvmMemInfo(jvmMaxMemory=" + this.getJvmMaxMemory() +
                    ", jvmUsableMemory=" + this.getJvmUsableMemory() +
                    ", jvmTotalMemory=" + this.getJvmTotalMemory() +
                    ", jvmUsedMemory=" + this.getJvmUsedMemory() +
                    ", jvmFreeMemory=" + this.getJvmFreeMemory() +
                    ", jvmMemoryUsedRate=" + this.getJvmMemoryUsedRate() +
                    ")";
        }
    }
    ...
    public static class SysJavaInfo {
        ...
        public String toString() {
            return "SysMachineResult.SysJavaInfo(jvmName=" + this.getJvmName() +
                    ", jvmVersion=" + this.getJvmVersion() +
                    ", jvmVendor=" + this.getJvmVendor() +
                    ", javaName=" + this.getJavaName() +
    ...
    public static class SysOsInfo {
        ...
        public String toString() {
            return "SysMachineResult.SysOsInfo(osName=" + this.getOsName() +
                    ", osArch=" + this.getOsArch() +
                    ", osVersion=" + this.getOsVersion() +
                    ", osHostName=" + this.getOsHostName() +
                    ", osHostAddress=" + this.getOsHostAddress() +
                    ")";
        }
    }
