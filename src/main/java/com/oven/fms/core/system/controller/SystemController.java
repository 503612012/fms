...
import com.oven.fms.common.util.CommonUtils;
import com.oven.fms.core.employee.entity.Employee;
import com.oven.fms.core.employee.service.EmployeeService;
import com.oven.fms.core.log.service.LogService;
import com.oven.fms.core.menu.service.MenuService;
import com.oven.fms.core.system.service.SysDicService;
import com.oven.fms.core.user.entity.User;
import com.oven.fms.core.user.service.UserService;
import com.oven.fms.framework.annotation.Anonymous;
import com.oven.fms.framework.annotation.AspectLog;
import com.oven.fms.framework.config.RsaProperties;
import com.oven.fms.framework.exception.MyException;
import com.oven.fms.framework.limitation.Limit;
import com.oven.fms.framework.limitation.LimitKey;
import com.oven.fms.framework.limitation.LimitType;
...
public class SystemController {
    ...
    public Result<Object> secKill() {
        try {
            ...
            return Result.fail(ResultCode.SEC_KILL_ERROR);
        }
    }
        ...
        try {
            ...
            if (userInDb.getErrNum() >= 5 && (userInDb.getId() != 1 && userInDb.getId() != 2)) {
                logService.addLog("登录系统！",
                        "失败[用户名：" + userName + "，失败原因：" + ResultCode.OVER_WRONG_NUM.message() + "]",
                        0,
                        userName,
            ...
            if (e instanceof UnknownAccountException) {
                logService.addLog("登录系统！",
                        "失败[用户名：" + userName + "，失败原因：" + ResultCode.NO_THIS_USER.message() + "]",
                        0,
                        "",
                        IPUtils.getClientIPAddr(req),
                        req.getRequestURI(),
                ...
                logService.addLog("登录系统！",
                        "失败[用户名：" + userName + "，失败原因：" + ResultCode.PASSWORD_WRONG.message() + "]",
                        userInDb.getId(),
                        userInDb.getNickName(),
                        IPUtils.getClientIPAddr(req),
                        req.getRequestURI(),
                        req.getMethod());
                ...
                logService.addLog("登录系统！",
                        "失败[用户名：" + userName + "，失败原因：" + ResultCode.USER_DISABLE.message() + "]",
                        userInDb.getId(),
                        userInDb.getNickName(),
                        IPUtils.getClientIPAddr(req),
                        req.getRequestURI(),
