package com.oven.fms.framework.limitation;
...
public interface LimitKey {
    ...
    String ADVANCESALARY_INSERT_LIMIT_KEY = "com.oven.fms.core.advanceSalary.insert.limit.key";
    String ADVANCESALARY_DELETE_LIMIT_KEY = "com.oven.fms.core.advanceSalary.delete.limit.key";
